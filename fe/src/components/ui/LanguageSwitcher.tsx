...
export function LanguageSwitcher() {
  ...
  return (
    ...
    <div
      className="flex items-center gap-0.5 rounded-full bg-gray-100 p-0.5 dark:bg-[#0c1a12]"
      role="group"
        ...
        return (
          <button
            ...
            className={`cursor-pointer rounded-full px-2.5 py-1 text-xs font-bold transition-colors ${
              isActive
                ? "bg-white text-accent-700 shadow-sm dark:bg-[#23392b] dark:text-accent-400"
