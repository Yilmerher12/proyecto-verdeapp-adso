      ...
      <div className="relative">
        ...
        */}
        ...
        <input
          ...
          className={`block w-full rounded-lg border ${icon ? "pl-10" : "px-3"} ${isPassword ? "pr-10" : icon ? "pr-3" : ""} py-2.5 text-sm transition-colors duration-200 placeholder:text-gray-400 focus:outline-none focus:ring-2 dark:bg-[#1a3324] dark:text-gray-100 dark:placeholder:text-gray-500 ${
            error
              ? "border-red-500 focus:border-red-500 focus:ring-red-500/20 dark:border-red-400 dark:focus:ring-red-400/20"
              : "border-gray-300 focus:border-accent-500 focus:ring-accent-500/20 dark:border-[#23392b] dark:focus:border-accent-400 dark:focus:ring-accent-400/20"
          }`}
        />
