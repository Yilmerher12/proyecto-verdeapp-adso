    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 selection:bg-green-200 selection:text-green-900">
      ...
      <main>
        ...
        >
          ...
          <h1
            id="hero-heading"
            className="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-6xl mb-6 text-center"
          >
            VerdeApp
          </h1>{" "}
          <div className="mx-auto max-w-3xl text-center animate-fade-in">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300 mb-10">
              Optimización en la comunicación entre tu conjunto y los recicladores locales. Gestiona
              el estado de tus residuos al instante, accede a educación ambiental y haz que el
              proceso sea más fácil y eficiente para todos.
            </p>
            ...
            <ul className="m-0 grid list-none grid-cols-1 gap-8 p-0 sm:grid-cols-3">
              <li>
                <article className="h-full rounded-3xl border border-gray-100 bg-white p-8 shadow-sm transition-shadow hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    [Editar descripción. Ejemplo: Facilita la separación de residuos en la fuente
                    para los residentes.]
                  </p>
                </article>
              </li>
              ...
              <li>
                <article className="h-full rounded-3xl border border-gray-100 bg-white p-8 shadow-sm transition-shadow hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    [Editar descripción. Ejemplo: Dignifica la labor del reciclador mediante
              ...
              <li>
                <article className="h-full rounded-3xl border border-gray-100 bg-white p-8 shadow-sm transition-shadow hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                    [Editar descripción. Ejemplo: Directorio geolocalizado de puntos de acopio
                    autorizados en Bogotá.]
                  </p>
                </article>
              </li>
            </ul>
          ...
          >
            <ul className="m-0 flex list-none flex-wrap justify-center gap-x-6 gap-y-2 p-0">
              <li>
                <Link
                  to="/terminos-de-uso"
                  className="rounded text-xs text-gray-500 hover:text-green-600 transition-colors"
                >
                  Términos de uso
                </Link>
              </li>
